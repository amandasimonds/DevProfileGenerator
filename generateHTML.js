          ...
          <div class="container">
              ...
              <main>
                  ...
                  <div class="photo-header card photo-header h1 phot-header h2">
                      ...
                      <img class="photo-header img" src="https://avatars1.githubusercontent.com/u/51679378?v=4" alt="">
                      <div style="display: inline-block;">
                              <h3>Hi!</h3><br> 
                              <h4>My name is ${data.data.login}</h4>
                              <br>
                              <div class="links-nav nav-link">
                                  <a href="${data.data.location}">Location</a>
                                  <a href="${data.data.url}">GitHub</a>
